...
class CalculadoraProbabilidadeAdocaoTest {
    ...
    void probabilidadeAltaCenario1() {
        ...
        ProbabilidadeAdocao prbabilidade = calculadora.calcular(pet);

        Assertions.assertEquals(ProbabilidadeAdocao.ALTA, prbabilidade);
    }
    ...
    void probabilidadeMediaCenario2() {
        ...
        Assertions.assertEquals(ProbabilidadeAdocao.MEDIA, prbabilidade);
    }
}